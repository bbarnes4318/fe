...
def send_email_notification(prospect_data, proxy_ip=None):
    """Email sending disabled: stubbed to no-op."""
    logger.info("Email notification disabled; skipping send.")
    return False
...
def api_submit():
    ...
    try:
        ...
        # Email sending disabled; proceed directly with success response
